...
// Rate limiting removed for ticket download to avoid issues in dev/production for admin actions
// if needed, re-implement with a more robust backend store (Redis) instead of in-memory LRU
